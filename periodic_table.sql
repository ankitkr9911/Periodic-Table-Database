...
--
-- Name: properties fk_1; Type: FK CONSTRAINT; Schema: public; Owner: freecodecamp
--

ALTER TABLE ONLY public.properties
    ADD CONSTRAINT fk_1 FOREIGN KEY (atomic_number) REFERENCES public.elements(atomic_number) ON UPDATE CASCADE ON DELETE CASCADE;
